...
public class TestCategoriesActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if(mAuth.getCurrentUser()!=null){
                    ...
                    startActivity(new Intent(TestCategoriesActivity.this,StartActivity.class));
                    finishAffinity();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.allMixed:
                ...
                Intent mixIntent = new Intent(TestCategoriesActivity.this,TestBoardActivity.class);
                mixIntent.putExtra("category","1");
                startActivity(mixIntent);
                finish();
                break;
            case R.id.aptitude:
                Intent apIntent = new Intent(TestCategoriesActivity.this,TestBoardActivity.class);
                apIntent.putExtra("category","2");
                startActivity(apIntent);
                finish();
                break;
            case R.id.reasoning:
                Intent reaIntent = new Intent(TestCategoriesActivity.this,TestBoardActivity.class);
                reaIntent.putExtra("category","3");
                startActivity(reaIntent);
                finish();
                break;
            case R.id.programing:
                startActivity(new Intent(TestCategoriesActivity.this,TestProgramingCataActivity.class));
                finish();
                break;
            case R.id.nav_menu :
            ...
            case R.id.backArrowBtn:
                startActivity(new Intent(TestCategoriesActivity.this,ChoicesActivity.class));
               finish();
               break;
