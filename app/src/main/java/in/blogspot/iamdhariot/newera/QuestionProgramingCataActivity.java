...
public class QuestionProgramingCataActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_programing_cata_question);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if(mAuth.getCurrentUser()!=null){
                    ...
                    startActivity(new Intent(QuestionProgramingCataActivity.this,StartActivity.class));
                    finishAffinity();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.c:
                ...
                Intent cIntent = new Intent(QuestionProgramingCataActivity.this,QuestionBoardActivity.class);
                cIntent.putExtra("category","4");
                startActivity(cIntent);
                break;
            case R.id.cpp:
                Intent cppIntent = new Intent(QuestionProgramingCataActivity.this,QuestionBoardActivity.class);
                cppIntent.putExtra("category","5");
                startActivity(cppIntent);
                break;
            case R.id.csharp:
                Intent cShIntent = new Intent(QuestionProgramingCataActivity.this,QuestionBoardActivity.class);
                cShIntent.putExtra("category","6");
                startActivity(cShIntent);
                break;
            case R.id.css:
                Intent cssIntent = new Intent(QuestionProgramingCataActivity.this,QuestionBoardActivity.class);
                cssIntent.putExtra("category","7");
                startActivity(cssIntent);
                break;
            case R.id.javaScript:
                Intent javaSIntent = new Intent(QuestionProgramingCataActivity.this,QuestionBoardActivity.class);
                javaSIntent.putExtra("category","8");
                startActivity(javaSIntent);
                break;
            case R.id.java:
                Intent javaIntent = new Intent(QuestionProgramingCataActivity.this,QuestionBoardActivity.class);
                javaIntent.putExtra("category","9");
                startActivity(javaIntent);
                break;
            case R.id.html:
                Intent htmlIntent = new Intent(QuestionProgramingCataActivity.this,QuestionBoardActivity.class);
                htmlIntent.putExtra("category","10");
                startActivity(htmlIntent);
                break;
            case R.id.mySQL:
                Intent myIntent = new Intent(QuestionProgramingCataActivity.this,QuestionBoardActivity.class);
                myIntent.putExtra("category","11");
                startActivity(myIntent);
                break;
            case R.id.python:
                Intent pyIntent = new Intent(QuestionProgramingCataActivity.this,QuestionBoardActivity.class);
                pyIntent.putExtra("category","12");
                startActivity(pyIntent);
                break;
            case R.id.android:
                Intent andIntent = new Intent(QuestionProgramingCataActivity.this,QuestionBoardActivity.class);
                andIntent.putExtra("category","13");
                startActivity(andIntent);
                break;
            case R.id.backArrowBtn:
                startActivity(new Intent(QuestionProgramingCataActivity.this,TestCategoriesActivity.class));
                finish();
                break;
            case R.id.nav_menu :
